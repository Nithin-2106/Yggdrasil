...
const FILTERS = [
  ...
  { label: 'Series',  display: 'Series',  color: C.primary },
  { label: 'Movie',   display: 'Movie',   color: C.gold },
  { label: 'OVA',     display: 'OVA',     color: C.aurora },
  { label: 'Special', display: 'Special', color: C.green },
]
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          background: `linear-gradient(to top, ${fColor}22, transparent 60%)`,
          opacity: hovered ? 1 : 0,
    ...
    <>
        ...
        <div style={{ flex: 1, position: 'relative' }}>
          ...
          <input
            ...
            style={{
              ...
              boxShadow: focused ? '0 0 20px rgba(94,234,212,0.12)' : 'none',
              transition: 'all 0.25s ease',
            }}
          />
        </div>
      ...
      <div style={{
        ...
        {!loading && filtered.map(item => (
          <ResultCard key={item.id} item={item} onSelect={onSelectAnime} />
        ))}
      </div>
